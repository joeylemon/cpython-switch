...
#define star_targets_list_seq_type 1133
#define star_targets_tuple_seq_type 1134
#define star_target_type 1135
#define target_with_star_atom_type 1136
...
#define invalid_parameters_helper_type 1159
#define invalid_lambda_parameters_type 1160
#define invalid_lambda_parameters_helper_type 1161
...
#define invalid_with_stmt_type 1169
...
#define _loop0_93_type 1262
#define _gather_92_type 1263
#define _tmp_94_type 1264
#define _tmp_95_type 1265
#define _tmp_96_type 1266
#define _tmp_97_type 1267
#define _loop1_98_type 1268
#define _tmp_99_type 1269
#define _tmp_100_type 1270
#define _loop0_102_type 1271
#define _gather_101_type 1272
#define _loop1_103_type 1273
#define _loop0_104_type 1274
#define _loop0_105_type 1275
#define _loop0_107_type 1276
#define _gather_106_type 1277
#define _tmp_108_type 1278
...
#define _loop0_116_type 1285
#define _gather_115_type 1286
#define _loop0_117_type 1287
#define _loop0_119_type 1288
#define _gather_118_type 1289
#define _loop1_120_type 1290
#define _tmp_121_type 1291
#define _loop0_123_type 1292
#define _gather_122_type 1293
#define _loop0_125_type 1294
#define _gather_124_type 1295
#define _tmp_126_type 1296
#define _loop0_127_type 1297
#define _loop0_128_type 1298
#define _loop0_129_type 1299
#define _tmp_130_type 1300
#define _tmp_131_type 1301
#define _tmp_132_type 1302
#define _loop0_133_type 1303
#define _loop1_134_type 1304
#define _loop0_135_type 1305
#define _loop1_136_type 1306
#define _tmp_137_type 1307
#define _tmp_138_type 1308
#define _tmp_139_type 1309
#define _loop0_141_type 1310
#define _gather_140_type 1311
#define _loop0_143_type 1312
#define _gather_142_type 1313
#define _tmp_144_type 1314
#define _tmp_145_type 1315
#define _tmp_146_type 1316
#define _tmp_147_type 1317
...
scase_stmt_rule(Parser *p)
{
    ...
    { // 'scase' named_expression &&':' block scase_stmt
        ...
        )
        {
            ...
            int _end_col_offset = _token->end_col_offset;
            UNUSED(_end_col_offset); // Only used by EXTRA macro
            _res = _Py_Scase ( a , b , CHECK ( asdl_stmt_seq * , _PyPegen_singleton_seq ( p , c ) ) , EXTRA );
            if (_res == NULL && PyErr_Occurred()) {
                p->error_indicator = 1;
                D(p->level--);
                return NULL;
...
// switch_block: NEWLINE INDENT scase_stmt DEDENT | NEWLINE INDENT sdefault_block? DEDENT
static asdl_stmt_seq*
switch_block_rule(Parser *p)
{
    ...
    int _mark = p->mark;
    { // NEWLINE INDENT scase_stmt DEDENT
        if (p->error_indicator) {
            D(p->level--);
            return NULL;
        }
        D(fprintf(stderr, "%*c> switch_block[%d-%d]: %s\n", p->level, ' ', _mark, p->mark, "NEWLINE INDENT scase_stmt DEDENT"));
        stmt_ty a;
        Token * dedent_var;
        Token * indent_var;
        Token * newline_var;
        if (
            ...
            &&
            (a = scase_stmt_rule(p))  // scase_stmt
            &&
        ...
        D(fprintf(stderr, "%*c%s switch_block[%d-%d]: %s failed!\n", p->level, ' ',
                  p->error_indicator ? "ERROR!" : "-", _mark, p->mark, "NEWLINE INDENT scase_stmt DEDENT"));
    }
    { // NEWLINE INDENT sdefault_block? DEDENT
        if (p->error_indicator) {
            D(p->level--);
            return NULL;
        }
        D(fprintf(stderr, "%*c> switch_block[%d-%d]: %s\n", p->level, ' ', _mark, p->mark, "NEWLINE INDENT sdefault_block? DEDENT"));
        void *a;
        Token * dedent_var;
        Token * indent_var;
        Token * newline_var;
        if (
            ...
            (indent_var = _PyPegen_expect_token(p, INDENT))  // token='INDENT'
            &&
            (a = sdefault_block_rule(p), 1)  // sdefault_block?
            &&
            (dedent_var = _PyPegen_expect_token(p, DEDENT))  // token='DEDENT'
        )
        {
        ...
        p->mark = _mark;
        D(fprintf(stderr, "%*c%s switch_block[%d-%d]: %s failed!\n", p->level, ' ',
                  p->error_indicator ? "ERROR!" : "-", _mark, p->mark, "NEWLINE INDENT sdefault_block? DEDENT"));
    }
    _res = NULL;
  done:
